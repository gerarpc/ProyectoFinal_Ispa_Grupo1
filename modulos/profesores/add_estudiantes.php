          ...
          <div class="card">
            <div class="card-header">
                <div class="list-group list-group-horizontal" id="list-tab" role="tablist">
                    <a>Creacion de estudiantes</a>
                    <a href="./estudiantes.php" class="btn btn-primary ml-auto" role="button" aria-pressed="true">Regresar</a>
                </div>
            </div>
            <div class="card-body">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-login" role="tabpanel"
                        ...
                        <?php
                            ...
                            if ($_GET['confirm'] === "1") {
                                echo '<div class="alert alert-success" role="alert">Se ha agregado el estudiante correctamente</div>';
                            }
                            if ($_GET['confirm'] === "2") {
                                echo '<div class="alert alert-danger" role="alert">Uno o mas campos vacios</div>';
                            }
                            if ($_GET['confirm'] === "3") {
                                echo '<div class="alert alert-danger" role="alert">El numero de identificacion ya esta registrado</div>';
                            }
                            //if ($_GET['confirm'] === "0")
                            }
                        ?>
                        <form action="../config/registrar.php" method="POST">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telefono" id="Telefono"aria-describedby="TelefonoHelp">
                                </div>
